...
import { type CredentialRequest, credentialFromRequest, enforceCredentialPolicy, filterCredentialModels } from "@/lib/security/ai-credential";
...
export async function POST(request: Request) {
  ...
  let body: CredentialRequest; try { body = await request.json(); } catch { return Response.json({ error: "Invalid JSON body." }, { status: 400 }); }
