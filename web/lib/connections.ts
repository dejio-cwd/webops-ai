...
export interface AiConnection { id: string; label: string; provider: ProviderId; apiKey?: string; baseUrl?: string; model?: string; createdAt: string; lastTestedAt?: string; lastTestOk?: boolean; lastTestMessage?: string }
...
export function toCredential(connection?: AiConnection | null) { return connection ? { provider: connection.provider, apiKey: connection.apiKey, baseUrl: connection.baseUrl, model: connection.model } : undefined; }
